...
const dashboardLinks: IDashboardLink[] = [
  ...
  { title: "My Statistics", href: "/dashboard/my-statistics", icon: <FaChartLine className='w-5 h-5' /> },
]

const adminLinks: IDashboardLink[] = [
  { title: "All Donations", href: "/admin/all-donations", icon: <FaDollarSign className='w-5 h-5' /> },
  { title: "Donations Statistics", href: "/admin/donations-statistics", icon: <FaChartLine className='w-5 h-5' /> },
