  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12'>
      ...
      <div className='md:pl-8'>
        <p className='text-lg font-semibold text-gray-500 mb-2'>About Us</p>
        <h6 className='text-3xl font-extrabold mb-3'>Rise Your Hand To Help The Poor Children</h6>
        ...
        <ul className='grid grid-cols-1 lg:grid-cols-2 gap-4 text-xl font-semibold'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center mt-8 gap-4 md:gap-8'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-2xl font-medium'>+888(888) 8888</p>
            </div>
          </div>
        </div>
      </div>
